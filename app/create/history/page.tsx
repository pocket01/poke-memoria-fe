...
import { ChevronLeft, ChevronRight, Clock, RotateCcw, Zap } from "lucide-react";
...
export default function HistoryPage() {
	...
	return (
		<div className="min-h-screen flex flex-col">
			...
			<div className="bg-white px-6 py-4">
				<div className="max-w-4xl mx-auto flex items-center justify-center gap-4">
					...
					<div className="flex items-center gap-2">
						...
						<span className="font-bold text-sm">軌跡</span>
					</div>
			...
			{/* フッター */}
			<footer className="bg-white border-t-2 border-gray-300 shadow-lg px-6 py-6 mt-8">
				<div className="max-w-4xl mx-auto flex items-center justify-between">
					...
					<p className="text-sm text-gray-600">ステップ 2 / 4</p>
					<button
						type="button"
						onClick={handleNext}
